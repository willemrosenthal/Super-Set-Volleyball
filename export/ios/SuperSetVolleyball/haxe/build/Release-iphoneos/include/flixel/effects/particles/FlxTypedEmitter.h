...
class HXCPP_CLASS_ATTRIBUTES  FlxTypedEmitter_obj : public ::flixel::group::FlxTypedGroup_obj{
	...
	public:
		...
		virtual ::flixel::effects::particles::FlxTypedEmitter makeParticles( Dynamic Graphics,hx::Null< int >  Quantity,hx::Null< int >  BakedRotations,hx::Null< bool >  Multiple,hx::Null< Float >  Collide,hx::Null< bool >  AutoBuffer);
