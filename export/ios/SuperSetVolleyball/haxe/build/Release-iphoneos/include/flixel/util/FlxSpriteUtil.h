...
class HXCPP_CLASS_ATTRIBUTES  FlxSpriteUtil_obj : public hx::Object{
	...
	public:
		...
		static Void drawRect( ::flixel::FlxSprite sprite,Float X,Float Y,Float Width,Float Height,int Color,Dynamic lineStyle);
		static Dynamic drawRect_dyn();

		static Void drawRoundRect( ::flixel::FlxSprite sprite,Float X,Float Y,Float Width,Float Height,Float EllipseWidth,Float EllipseHeight,int Color,Dynamic lineStyle);
		static Dynamic drawRoundRect_dyn();

		static Void drawCircle( ::flixel::FlxSprite sprite,Float X,Float Y,Float Radius,int Color,Dynamic lineStyle);
		static Dynamic drawCircle_dyn();

		static Void drawEllipse( ::flixel::FlxSprite sprite,Float X,Float Y,Float Width,Float Height,int Color,Dynamic lineStyle);
