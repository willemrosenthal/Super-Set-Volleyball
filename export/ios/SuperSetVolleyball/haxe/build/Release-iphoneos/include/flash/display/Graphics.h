...
class HXCPP_CLASS_ATTRIBUTES  Graphics_obj : public hx::Object{
	...
	public:
		...
		virtual Void drawTriangles( Array< Float > vertices,Array< int > indices,Array< Float > uvtData,::flash::display::TriangleCulling culling,Array< int > colors,hx::Null< int >  blendMode,Array< Float > viewport);
		Dynamic drawTriangles_dyn();

		virtual Void drawTiles( ::openfl::display::Tilesheet sheet,Array< Float > data,hx::Null< bool >  smooth,hx::Null< int >  flags);
