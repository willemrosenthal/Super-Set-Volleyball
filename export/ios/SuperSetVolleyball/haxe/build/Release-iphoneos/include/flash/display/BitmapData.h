...
class HXCPP_CLASS_ATTRIBUTES  BitmapData_obj : public hx::Object{
	...
	public:
		...
		virtual Void setAlphaMode( int alphaMode);
		...
		static Dynamic lime_bitmap_data_set_alpha_mode;
		static Dynamic &lime_bitmap_data_set_alpha_mode_dyn() { return lime_bitmap_data_set_alpha_mode;}
};
