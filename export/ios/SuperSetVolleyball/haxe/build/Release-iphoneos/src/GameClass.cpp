...
{
HX_STACK_PUSH("GameClass::new","GameClass.hx",11);
{
	HX_STACK_LINE(12)
	...
	HX_STACK_LINE(22)
	super::__construct(::Std_obj::_int(::Math_obj::ceil(ratioX)),::Std_obj::_int(::Math_obj::ceil(ratioY)),hx::ClassOf< ::PlayState >(),zoom,fps,fps,true,null());
}
;
	return null();
}
