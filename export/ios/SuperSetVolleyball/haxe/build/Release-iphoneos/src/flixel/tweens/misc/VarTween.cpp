...
{
HX_STACK_PUSH("VarTween::new","flixel/tweens/misc/VarTween.hx",17);
...
{
		HX_STACK_PUSH("VarTween::update","flixel/tweens/misc/VarTween.hx",70);
		HX_STACK_THIS(this);
		HX_STACK_LINE(71)
		this->super::update();
		HX_STACK_LINE(72)
...
::flixel::tweens::misc::VarTween VarTween_obj::tween( Dynamic object,::String property,Float to,Float duration,Dynamic ease){
	HX_STACK_PUSH("VarTween::tween","flixel/tweens/misc/VarTween.hx",36);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::flixel::tweens::misc::VarTween_obj *__this,::String &property){
			HX_STACK_PUSH("*::closure","flixel/tweens/misc/VarTween.hx",49);
			{
				HX_STACK_LINE(49)
...
{
		HX_STACK_PUSH("VarTween::destroy","flixel/tweens/misc/VarTween.hx",22);
		HX_STACK_THIS(this);
		HX_STACK_LINE(23)
		this->super::destroy();
		HX_STACK_LINE(24)
