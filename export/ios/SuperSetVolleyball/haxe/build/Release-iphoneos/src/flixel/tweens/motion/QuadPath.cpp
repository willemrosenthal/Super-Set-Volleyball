...
Float QuadPath_obj::curveLength( ::flixel::util::FlxPoint start,::flixel::util::FlxPoint control,::flixel::util::FlxPoint finish){
	HX_STACK_PUSH("QuadPath::curveLength","flixel/tweens/motion/QuadPath.hx",212);
	HX_STACK_THIS(this);
...
Float QuadPath_obj::get_pointCount( ){
	HX_STACK_PUSH("QuadPath::get_pointCount","flixel/tweens/motion/QuadPath.hx",208);
	HX_STACK_THIS(this);
	HX_STACK_LINE(208)
...
{
		HX_STACK_PUSH("QuadPath::updatePath","flixel/tweens/motion/QuadPath.hx",169);
		HX_STACK_THIS(this);
		HX_STACK_LINE(170)
		...
		while(((i < this->_numSegs))){
			...
			j = (i * (int)2);
			HX_STACK_LINE(188)
			this->_curveD[i] = this->curveLength(this->_points->__get(j).StaticCast< ::flixel::util::FlxPoint >(),this->_points->__get((j + (int)1)).StaticCast< ::flixel::util::FlxPoint >(),this->_points->__get((j + (int)2)).StaticCast< ::flixel::util::FlxPoint >());
			HX_STACK_LINE(189)
...
{
		HX_STACK_PUSH("QuadPath::update","flixel/tweens/motion/QuadPath.hx",110);
		HX_STACK_THIS(this);
		HX_STACK_LINE(111)
		this->super::update();
		HX_STACK_LINE(112)
		...
		if (((bool(!(this->_backward)) && bool((this->_points != null()))))){
			...
			if (((this->_points != null()))){
				...
				if (((this->_index > (int)0))){
					HX_STACK_LINE(141)
					while(((this->_t < this->_curveT->__get(this->_index)))){
						HX_STACK_LINE(144)
						(this->_index)--;
						HX_STACK_LINE(145)
						if (((this->_index == (int)0))){
...
Dynamic QuadPath_obj::start( ){
	HX_STACK_PUSH("QuadPath::start","flixel/tweens/motion/QuadPath.hx",94);
	HX_STACK_THIS(this);
	HX_STACK_LINE(95)
	if ((!(this->_backward))){
		HX_STACK_LINE(96)
...
int index = __o_index.Default(0);
	HX_STACK_PUSH("QuadPath::getPoint","flixel/tweens/motion/QuadPath.hx",84);
	HX_STACK_THIS(this);
...
Float y = __o_y.Default(0);
	HX_STACK_PUSH("QuadPath::addPoint","flixel/tweens/motion/QuadPath.hx",72);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_ARG(y,"y");
{
...
bool UseDuration = __o_UseDuration.Default(true);
	HX_STACK_PUSH("QuadPath::setMotion","flixel/tweens/motion/QuadPath.hx",47);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("QuadPath::destroy","flixel/tweens/motion/QuadPath.hx",30);
		HX_STACK_THIS(this);
		HX_STACK_LINE(31)
		this->super::destroy();
		HX_STACK_LINE(32)
