	...
	HX_STACK_ARG(Empties,"Empties");
{
		...
		HX_STACK_LINE(58)
		if (((hx::Mod(this->get_width(),sprite->get_width()) != (int)0))){
			HX_STACK_LINE(60)
		...
		HX_STACK_LINE(64)
		if (((hx::Mod(this->get_height(),sprite->get_height()) != (int)0))){
			HX_STACK_LINE(66)
		...
		if ((regen)){
			HX_STACK_LINE(71)
			this->makeGraphic(::Std_obj::_int(this->get_width()),::Std_obj::_int(this->get_height()),(int)0,true,null());
		}
		else{
			HX_STACK_LINE(75)
