...
{
		HX_STACK_PUSH("FlxG::init","flixel/FlxG.hx",242);
...
Void FlxG_obj::reset( ){
{
		HX_STACK_PUSH("FlxG::reset","flixel/FlxG.hx",284);
		HX_STACK_LINE(285)
...
::String FlxG_obj::get_libraryName( ){
	HX_STACK_PUSH("FlxG::get_libraryName","flixel/FlxG.hx",304);
	HX_STACK_LINE(304)
...
int FlxG_obj::get_framerate( ){
	HX_STACK_PUSH("FlxG::get_framerate","flixel/FlxG.hx",315);
	HX_STACK_LINE(315)
...
int FlxG_obj::set_framerate( int Framerate){
	HX_STACK_PUSH("FlxG::set_framerate","flixel/FlxG.hx",320);
...
int FlxG_obj::get_flashFramerate( ){
	HX_STACK_PUSH("FlxG::get_flashFramerate","flixel/FlxG.hx",344);
	HX_STACK_LINE(345)
...
int FlxG_obj::set_flashFramerate( int Framerate){
	HX_STACK_PUSH("FlxG::set_flashFramerate","flixel/FlxG.hx",354);
	HX_STACK_ARG(Framerate,"Framerate");
	HX_STACK_LINE(355)
...
{
		HX_STACK_PUSH("FlxG::resetGame","flixel/FlxG.hx",381);
		HX_STACK_LINE(381)
...
{
		HX_STACK_PUSH("FlxG::resizeGame","flixel/FlxG.hx",390);
		HX_STACK_ARG(Width,"Width");
		HX_STACK_ARG(Height,"Height");
		HX_STACK_LINE(391)
		{
...
bool FlxG_obj::set_fullscreen( bool Value){
	HX_STACK_PUSH("FlxG::set_fullscreen","flixel/FlxG.hx",403);
...
::flash::display::Stage FlxG_obj::get_stage( ){
	HX_STACK_PUSH("FlxG::get_stage","flixel/FlxG.hx",428);
	HX_STACK_LINE(428)
...
::flixel::FlxState FlxG_obj::get_state( ){
	HX_STACK_PUSH("FlxG::get_state","flixel/FlxG.hx",438);
	HX_STACK_LINE(438)
...
{
		HX_STACK_PUSH("FlxG::switchState","flixel/FlxG.hx",446);
...
{
		HX_STACK_PUSH("FlxG::resetState","flixel/FlxG.hx",454);
		struct _Function_1_1{
			inline static ::String Block( ){
				HX_STACK_PUSH("*::closure","flixel/FlxG.hx",455);
				{
					HX_STACK_LINE(455)
...
bool FlxG_obj::overlap( ::flixel::FlxBasic ObjectOrGroup1,::flixel::FlxBasic ObjectOrGroup2,Dynamic NotifyCallback,Dynamic ProcessCallback){
	HX_STACK_PUSH("FlxG::overlap","flixel/FlxG.hx",479);
...
int AlphaTolerance = __o_AlphaTolerance.Default(255);
	HX_STACK_PUSH("FlxG::pixelPerfectOverlap","flixel/FlxG.hx",510);
...
bool FlxG_obj::collide( ::flixel::FlxBasic ObjectOrGroup1,::flixel::FlxBasic ObjectOrGroup2,Dynamic NotifyCallback){
	HX_STACK_PUSH("FlxG::collide","flixel/FlxG.hx",529);
	HX_STACK_ARG(ObjectOrGroup1,"ObjectOrGroup1");
	HX_STACK_ARG(ObjectOrGroup2,"ObjectOrGroup2");
	HX_STACK_ARG(NotifyCallback,"NotifyCallback");
	HX_STACK_LINE(529)
...
Dynamic FlxG_obj::safeDestroy( ::flixel::IDestroyable Object){
	HX_STACK_PUSH("FlxG::safeDestroy","flixel/FlxG.hx",540);
...
struct _Function_0_1{
	inline static Dynamic Block( ){
		HX_STACK_PUSH("*::closure","flixel/FlxG.hx",54);
		{
	...
	LIBRARY_MINOR_VERSION= HX_CSTRING("0.2");
	paused= false;
	autoPause= true;
	autoResize= false;
	fixedTimestep= true;
