...
{
		HX_STACK_PUSH("MultiVarTween::update","flixel/tweens/misc/MultiVarTween.hx",89);
		HX_STACK_THIS(this);
		HX_STACK_LINE(90)
		this->super::update();
		HX_STACK_LINE(91)
...
::flixel::tweens::misc::MultiVarTween MultiVarTween_obj::tween( Dynamic object,Dynamic properties,Float duration,Dynamic ease){
	HX_STACK_PUSH("MultiVarTween::tween","flixel/tweens/misc/MultiVarTween.hx",45);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("MultiVarTween::destroy","flixel/tweens/misc/MultiVarTween.hx",29);
		HX_STACK_THIS(this);
		HX_STACK_LINE(30)
		this->super::destroy();
		HX_STACK_LINE(31)
