...
{
		HX_STACK_PUSH("TileSheetData::destroyFrameBitmapDatas","flixel/system/layer/TileSheetData.hx",288);
		HX_STACK_THIS(this);
		HX_STACK_LINE(289)
...
int startY = __o_startY.Default(0);
	HX_STACK_PUSH("TileSheetData::addTexturePackerFrame","flixel/system/layer/TileSheetData.hx",254);
	HX_STACK_THIS(this);
...
int startX = __o_startX.Default(0);
int startY = __o_startY.Default(0);
	HX_STACK_PUSH("TileSheetData::getTexturePackerFrames","flixel/system/layer/TileSheetData.hx",227);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("TileSheetData::onContext","flixel/system/layer/TileSheetData.hx",215);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("TileSheetData::destroy","flixel/system/layer/TileSheetData.hx",186);
		HX_STACK_THIS(this);
		HX_STACK_LINE(187)
		this->bitmap = null();
		HX_STACK_LINE(189)
		...
		struct _Function_1_2{
			inline static Dynamic Block( ::flixel::system::layer::TileSheetData_obj *__this){
				HX_STACK_PUSH("*::closure","flixel/system/layer/TileSheetData.hx",198);
				{
					HX_STACK_LINE(198)
					Array< ::Dynamic > _e = Array_obj< ::Dynamic >::__new().Add(__this->flxSpriteFrames);		HX_STACK_VAR(_e,"_e");
					...
					HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_2_1,Array< ::Dynamic >,_e)
					Dynamic run(){
						HX_STACK_PUSH("*::_Function_2_1","flixel/system/layer/TileSheetData.hx",198);
						{
							HX_STACK_LINE(198)
							return _e->__get((int)0).StaticCast< ::haxe::ds::StringMap >()->iterator();
						}
		...
		struct _Function_1_3{
			inline static Dynamic Block( ::flixel::system::layer::TileSheetData_obj *__this){
				HX_STACK_PUSH("*::closure","flixel/system/layer/TileSheetData.hx",204);
				{
					HX_STACK_LINE(204)
					...
					HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_2_1,Array< ::Dynamic >,_e)
					Dynamic run(){
						HX_STACK_PUSH("*::_Function_2_1","flixel/system/layer/TileSheetData.hx",204);
						{
							HX_STACK_LINE(204)
							return _e->__get((int)0).StaticCast< ::haxe::ds::StringMap >()->iterator();
						}
...
int TileSheetData_obj::addTileRect( ::flash::geom::Rectangle tileRect,::flash::geom::Point point){
	HX_STACK_PUSH("TileSheetData::addTileRect","flixel/system/layer/TileSheetData.hx",180);
	HX_STACK_THIS(this);
...
bool TileSheetData_obj::containsFrame( ::String key){
	HX_STACK_PUSH("TileSheetData::containsFrame","flixel/system/layer/TileSheetData.hx",174);
	HX_STACK_THIS(this);
...
::flixel::system::layer::frames::FlxFrame TileSheetData_obj::addSpriteSheetFrame( ::flash::geom::Rectangle rect,::flash::geom::Point point){
	HX_STACK_PUSH("TileSheetData::addSpriteSheetFrame","flixel/system/layer/TileSheetData.hx",148);
	HX_STACK_THIS(this);
...
bool TileSheetData_obj::containsSpriteSheetFrames( int width,int height,int startX,int startY,int endX,int endY,int xSpacing,int ySpacing,Float pointX,Float pointY){
	HX_STACK_PUSH("TileSheetData::containsSpriteSheetFrames","flixel/system/layer/TileSheetData.hx",139);
	HX_STACK_THIS(this);
...
::String TileSheetData_obj::getKeyForSpriteSheetFrames( int width,int height,int startX,int startY,int endX,int endY,int xSpacing,int ySpacing,Float pointX,Float pointY){
	HX_STACK_PUSH("TileSheetData::getKeyForSpriteSheetFrames","flixel/system/layer/TileSheetData.hx",134);
	HX_STACK_THIS(this);
	HX_STACK_ARG(width,"width");
	HX_STACK_ARG(height,"height");
	HX_STACK_ARG(startX,"startX");
