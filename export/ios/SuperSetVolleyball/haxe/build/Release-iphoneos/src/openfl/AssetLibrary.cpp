...
{
HX_STACK_PUSH("AssetLibrary::new","openfl/Assets.hx",1055);
{
}
;
	return null();
...
{
		HX_STACK_PUSH("AssetLibrary::loadSound","openfl/Assets.hx",1167);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
...
{
		HX_STACK_PUSH("AssetLibrary::loadMusic","openfl/Assets.hx",1160);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1160)
...
{
		HX_STACK_PUSH("AssetLibrary::loadMovieClip","openfl/Assets.hx",1153);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1153)
...
{
		HX_STACK_PUSH("AssetLibrary::loadFont","openfl/Assets.hx",1146);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1146)
...
{
		HX_STACK_PUSH("AssetLibrary::loadBytes","openfl/Assets.hx",1139);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1139)
...
{
		HX_STACK_PUSH("AssetLibrary::loadBitmapData","openfl/Assets.hx",1132);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1132)
...
{
		HX_STACK_PUSH("AssetLibrary::load","openfl/Assets.hx",1125);
		HX_STACK_THIS(this);
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1125)
...
bool AssetLibrary_obj::isLocal( ::String id,::openfl::AssetType type){
	HX_STACK_PUSH("AssetLibrary::isLocal","openfl/Assets.hx",1118);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
...
::flash::media::Sound AssetLibrary_obj::getSound( ::String id){
	HX_STACK_PUSH("AssetLibrary::getSound","openfl/Assets.hx",1111);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1111)
	return null();
...
::String AssetLibrary_obj::getPath( ::String id){
	HX_STACK_PUSH("AssetLibrary::getPath","openfl/Assets.hx",1104);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1104)
	return null();
...
::flash::media::Sound AssetLibrary_obj::getMusic( ::String id){
	HX_STACK_PUSH("AssetLibrary::getMusic","openfl/Assets.hx",1097);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1097)
...
::flash::display::MovieClip AssetLibrary_obj::getMovieClip( ::String id){
	HX_STACK_PUSH("AssetLibrary::getMovieClip","openfl/Assets.hx",1090);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1090)
	return null();
...
::flash::text::Font AssetLibrary_obj::getFont( ::String id){
	HX_STACK_PUSH("AssetLibrary::getFont","openfl/Assets.hx",1083);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1083)
	return null();
...
::flash::utils::ByteArray AssetLibrary_obj::getBytes( ::String id){
	HX_STACK_PUSH("AssetLibrary::getBytes","openfl/Assets.hx",1076);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1076)
	return null();
...
::flash::display::BitmapData AssetLibrary_obj::getBitmapData( ::String id){
	HX_STACK_PUSH("AssetLibrary::getBitmapData","openfl/Assets.hx",1069);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1069)
	return null();
...
bool AssetLibrary_obj::exists( ::String id,::openfl::AssetType type){
	HX_STACK_PUSH("AssetLibrary::exists","openfl/Assets.hx",1062);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_ARG(type,"type");
	HX_STACK_LINE(1062)
