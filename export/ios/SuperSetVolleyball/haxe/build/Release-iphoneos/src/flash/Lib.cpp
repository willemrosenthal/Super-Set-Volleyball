...
Dynamic Lib_obj::as( Dynamic v,::Class c){
	HX_STACK_PUSH("Lib::as","flash/Lib.hx",49);
	HX_STACK_ARG(v,"v");
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(49)
	return v;
...
::flash::display::MovieClip Lib_obj::attach( ::String name){
	HX_STACK_PUSH("Lib::attach","flash/Lib.hx",56);
...
Void Lib_obj::close( ){
{
		HX_STACK_PUSH("Lib::close","flash/Lib.hx",63);
		HX_STACK_LINE(65)
...
::String title = __o_title.Default(HX_CSTRING("OpenFL"));
	HX_STACK_PUSH("Lib::create","flash/Lib.hx",71);
	...
	HX_STACK_ARG(stageClass,"stageClass");
{
		...
		Void run(Dynamic frameHandle){
			HX_STACK_PUSH("*::_Function_1_1","flash/Lib.hx",92);
...
int flags = __o_flags.Default(0);
	HX_STACK_PUSH("Lib::createManagedStage","flash/Lib.hx",123);
	HX_STACK_ARG(width,"width");
	HX_STACK_ARG(height,"height");
	HX_STACK_ARG(flags,"flags");
{
...
::String Lib_obj::findHaxeLib( ::String library){
	HX_STACK_PUSH("Lib::findHaxeLib","flash/Lib.hx",136);
...
int args = __o_args.Default(0);
	HX_STACK_PUSH("Lib::load","flash/Lib.hx",177);
	HX_STACK_ARG(library,"library");
...
{
		HX_STACK_PUSH("Lib::loaderTrace","flash/Lib.hx",252);
...
{
		HX_STACK_PUSH("Lib::rethrow","flash/Lib.hx",270);
...
::String Lib_obj::sysName( ){
	HX_STACK_PUSH("Lib::sysName","flash/Lib.hx",309);
	HX_STACK_LINE(312)
...
Dynamic Lib_obj::tryLoad( ::String name,::String library,::String func,int args){
	HX_STACK_PUSH("Lib::tryLoad","flash/Lib.hx",321);
	HX_STACK_ARG(name,"name");
	HX_STACK_ARG(library,"library");
...
Void Lib_obj::exit( ){
{
		HX_STACK_PUSH("Lib::exit","flash/Lib.hx",374);
		HX_STACK_LINE(376)
...
{
		HX_STACK_PUSH("Lib::forceClose","flash/Lib.hx",395);
		HX_STACK_LINE(397)
...
int Lib_obj::getTimer( ){
	HX_STACK_PUSH("Lib::getTimer","flash/Lib.hx",403);
	HX_STACK_LINE(403)
...
{
		HX_STACK_PUSH("Lib::getURL","flash/Lib.hx",410);
...
Void Lib_obj::pause( ){
{
		HX_STACK_PUSH("Lib::pause","flash/Lib.hx",417);
		HX_STACK_LINE(417)
...
{
		HX_STACK_PUSH("Lib::postUICallback","flash/Lib.hx",424);
...
Void Lib_obj::resume( ){
{
		HX_STACK_PUSH("Lib::resume","flash/Lib.hx",435);
		HX_STACK_LINE(435)
...
{
		HX_STACK_PUSH("Lib::setIcon","flash/Lib.hx",442);
...
{
		HX_STACK_PUSH("Lib::setPackage","flash/Lib.hx",450);
...
{
		HX_STACK_PUSH("Lib::__setCurrentStage","flash/Lib.hx",462);
...
{
		HX_STACK_PUSH("Lib::trace","flash/Lib.hx",469);
		HX_STACK_ARG(arg,"arg");
		HX_STACK_LINE(469)
		::haxe::Log_obj::trace(arg,hx::SourceInfo(HX_CSTRING("Lib.hx"),471,HX_CSTRING("flash.Lib"),HX_CSTRING("trace")));
	}
return null();
}
...
::flash::display::MovieClip Lib_obj::get_current( ){
	HX_STACK_PUSH("Lib::get_current","flash/Lib.hx",483);
	HX_STACK_LINE(485)
	if (((::flash::Lib_obj::__current == null()))){
		HX_STACK_LINE(487)
...
::flash::display::Stage Lib_obj::get_stage( ){
	HX_STACK_PUSH("Lib::get_stage","flash/Lib.hx",502);
	HX_STACK_LINE(504)
	if (((::flash::Lib_obj::__stage == null()))){
		HX_STACK_LINE(504)
