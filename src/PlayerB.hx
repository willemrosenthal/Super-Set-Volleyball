...
class PlayerB extends FlxSprite
{
	...
	public function new(X:Float, Y:Float)
	{
		...
		loadGraphic("assets/blue_player.png", true, true, 61,82);
	...
	override public function update():Void
	{
        ...
        if (x < FlxG.worldBounds.x + FlxG.worldBounds.width * 0.5 - width * 0.23 && velocity.x < 0) {
            velocity.x = 0;
            x = FlxG.worldBounds.x + FlxG.worldBounds.width * 0.5 - width * 0.23;
            }
